# this file is needed to train task0 in the graph (it's a plain dqn for task0)
...
def learn(env,
    ...
    save_path = saver1.save(session, exp_dir + '/saved_model/conv_graph.ckpt', write_meta_graph=False)
    save_path2 = saver2.save(session, exp_dir + '/saved_model/flat_graph.ckpt', write_meta_graph=False)
