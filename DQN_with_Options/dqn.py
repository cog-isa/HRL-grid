...
def learn(env,
    ...
    with tf.variable_scope('option2_6_4_4'):
#         with tf.variable_scope("obs_t_ph"):
    ...
    with tf.variable_scope("Hold_the_var"):
        ...
        q_func_vars = tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='option2_6_4_4/q_func')
    ...
    saver = tf.train.Saver(tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope='option2_6_4_4'))
    ...
    meta_graph_def = tf.train.export_meta_graph(filename='option2_6_4_4/dqn_graph.ckpt.meta', export_scope = 'option2_6_4_4')
    save_path = saver.save(session, "option2_6_4_4/dqn_graph.ckpt", write_meta_graph = False)
